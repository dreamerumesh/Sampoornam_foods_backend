...
//     MONGO_URI: "mongodb://127.0.0.1:27017/mydatabase" || process.env.MONGO_URI || 'mongodb://localhost:27017/sampoornam-foods',
//     JWT_SECRET: process.env.JWT_SECRET || 'sampoornam-secret-key',
...
module.exports = {
    ...
    EMAIL_USER: process.env.EMAIL_USER || 'umeshchandra.g2005@gmail.com',
    EMAIL_PASS: process.env.EMAIL_PASS || 'urustenjtktbrszw',
